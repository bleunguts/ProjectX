...
class YearlyPnLTableBuilder : TradingSignalsTableBuilderBase
{
...
class PnLTableBuilder : TradingSignalsTableBuilderBase
{
    protected override DataColumn[] Headers => new[]
    {
...
class PnlRankingTableBuilder : TradingSignalsTableBuilderBase
{
...
abstract class TradingSignalsTableBuilderBase : TableBuilderBase
{

...
public class API
{
    ...
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern void DisposeAPI(IntPtr pClassNameObject);

    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_PV(IntPtr pClassNameObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_Delta(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_Gamma(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r, double epsilon);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_Vega(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_Theta(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_Rho(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern double BlackScholes_ImpliedVolatility(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double r, double optionPrice);
    [DllImport("ProjectX.AnalyticsLibNative")]
    static private extern GreekResults MonteCarlo_PV(IntPtr a_pObject, ref VanillaOptionParameters TheOption, double Spot, double Vol, double r, ulong NumberOfPaths);
    [DllImport("ProjectX.AnalyticsLibNative")]

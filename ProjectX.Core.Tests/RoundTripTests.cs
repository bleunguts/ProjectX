...
namespace ProjectX.Core.Tests
{
    public class RoundTripTests
    {
        ...
        public void CanJsonSerializeAndDeserializePlotResultsUsingMicrosoftJsonSerializer()
        {
            ...
            var obj = new PlotOptionsPricingResult(new PlotOptionsPricingRequest(OptionGreeks.Delta, OptionType.Call, 30, 0.6,0.5,0.3, OptionsPricingCalculatorType.OptionsPricer),
                new PlotResults()
                {
                    XLimitMin = 1,
                    XNumber = 2,
